    ...
    <div id="termo" className="my-10 flex w-full justify-center px-5">
      <div className=" flex w-full max-w-7xl flex-col gap-4">
        <div className="flex flex-col gap-4">
          <h1 className="text-3xl">Termo de Uso</h1>
          <p>
            <b> Última alteração:</b> 31/12/2023
          </p>

          <p>
            Seja bem-vindo ao site da DW Assessoria Contábel. Por favor, leia
            atentamente todos os termos abaixo.
          </p>

          <p>
            Este documento, juntamente com todo o conteúdo do site, é
            disponibilizado pela DW Assessoria Contábel, doravante referida como
          ...
          <p>
            A permanência no website implica automaticamente na leitura e
            aceitação tácita dos termos de uso a seguir.
          </p>
        </div>

        <div className="flex flex-col gap-4">
          <h2>DA FUNÇÃO DO SITE</h2>
          <p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            OAB/PI 15.613, modificado com permissão para este site.
          </p>
          <p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            VISITANTE deverá entrar em contato com a EMPRESA através dos canais
            de comunicação encontradas no site.
          </p>
        </div>
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            O site e a plataforma funcionam normalmente 24 horas por dia, com
            possíveis interrupções temporárias para ajustes, manutenção, mudança
            de servidores, falhas técnicas ou eventos de força maior. A EMPRESA
            não se responsabiliza por perdas de oportunidades ou prejuízos
            devido a indisponibilidade temporária. Em caso de manutenções que
            demandem mais tempo, a EMPRESA informará previamente aos clientes
            sobre a necessidade e o tempo previsto de indisponibilidade.
          </p>

          <p>
            O acesso ao site é permitido apenas para maiores de 18 anos ou
            aqueles com capacidade civil plena. Para menores de idade, é
            necessária a autorização expressa dos pais ou tutores, que serão
            responsáveis por qualquer compra ou acesso realizados pelo menor.
          </p>

          <p>
            Caso seja necessário o cadastro na plataforma, o VISITANTE concorda
            integralmente com a coleta de dados, conforme a Lei Geral de
            Proteção de Dados, e com a Política de Privacidade da EMPRESA.
          </p>
        </div>
