        ...
        <div id="termo" className="w-full flex justify-center my-10 px-5">
            <div className=" flex flex-col w-full max-w-7xl gap-4">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    <p>
                        O site e a plataforma funcionam normalmente 24 horas por dia, com possíveis interrupções temporárias para ajustes, manutenção, mudança de servidores, falhas técnicas ou eventos de força maior. A EMPRESA não se responsabiliza por perdas de oportunidades ou prejuízos devido a indisponibilidade temporária.
                        Em caso de manutenções que demandem mais tempo, a EMPRESA informará previamente aos clientes sobre a necessidade e o tempo previsto de indisponibilidade.
                    </p>

                    <p>
                        O acesso ao site é permitido apenas para maiores de 18 anos ou aqueles com capacidade civil plena. Para menores de idade, é necessária a autorização expressa dos pais ou tutores, que serão responsáveis por qualquer compra ou acesso realizados pelo menor.
                    </p>

                    <p>
                        Caso seja necessário o cadastro na plataforma, o VISITANTE concorda integralmente com a coleta de dados, conforme a Lei Geral de Proteção de Dados, e com a Política de Privacidade da EMPRESA.
                    </p>
                </div>
