        ...
        <div id="politica" className="w-full flex justify-center my-10">
            <div className=" flex flex-col w-full max-w-7xl gap-3">
                ...
                <div className="flex flex-col gap-3">
                    ...
                    <ul>
                        <li><strong>Cookies relacionados à conta</strong><br />Se você criar uma conta conosco, usaremos cookies para o gerenciamento do processo de inscrição e administração geral. Esses cookies geralmente serão excluídos quando você sair do sistema, porém, em alguns casos, eles poderão permanecer posteriormente para lembrar as preferências do seu site ao sair.<br /></li>
                        ...
                        <li><strong>Cookies relacionados a boletins por e-mail</strong><br />Este site oferece serviços de assinatura de boletim informativo ou e-mail e os cookies podem ser usados ​​para lembrar se você já está registrado e se deve mostrar determinadas notificações válidas apenas para usuários inscritos / não inscritos.<br /></li>


                        <li><strong>Cookies relacionados a pesquisas</strong><br />Periodicamente, oferecemos pesquisas e questionários para fornecer informações interessantes, ferramentas úteis ou para entender nossa base de usuários com mais precisão. Essas pesquisas podem usar cookies para lembrar quem já participou numa pesquisa ou para fornecer resultados precisos após a alteração das páginas.<br /></li>

                        <li><strong>Cookies relacionados a formulários</strong><br />Quando você envia dados por meio de um formulário como os encontrados nas páginas de contato ou nos formulários de comentários, os cookies podem ser configurados para lembrar os detalhes do usuário para correspondência futura.<br /></li>
                ...
                <ul>
                    <li>Para alterar seus dados pessoais acesse a opção "Entrar";</li>
                    ...
                    <li>Para mudar suas preferências em relação às notificações (incluindo as comunicações de marketing) acesse a opção "Entrar";</li>

                    <li>Para as demais solicitações em relação aos direitos do titular de dados pessoais, entre em contato conosco através <a href="https://www.contabilidadepartidaria.com.br" target="_blank">do nosso formulário</a>;</li>
                </ul>
