    ...
    <div id="politica" className="my-10 flex w-full justify-center px-5">
      <div className=" flex w-full max-w-7xl flex-col gap-4">
        <div className="flex flex-col gap-4">
          ...
          <p>
            A sua privacidade é importante para nós. É política do site DW
            Assessoria Contábel respeitar a sua privacidade em relação a
            qualquer informação sua que possamos coletar no site{' '}
            <a
              href="https://www.contabilidadepartidaria.com.br"
              target="_blank"
          ...
          <p>
            ...
            informações pessoais, entre em contato conosco através{' '}
            <a
              href="https://www.contabilidadepartidaria.com.br"
              target="_blank"
              rel="noreferrer"
          ...
          <p>
            ...
            Política de Privacidade pode ser alterado a critério do site DW
            Assessoria Contábel, independente de aviso ou notificação. Em caso
            de alteração, as modificações produzem todos os efeitos a partir do
        ...
        <div className="flex flex-col gap-4">
          ...
          <ol>
            ...
            <li>
              {' '}
              Respeito a todas as legislações nacionais ou internacionais em que
            ...
            <li>
              {' '}
              Os conteúdos publicados, possuem direitos autorais e de
        ...
        <p>
          O titular de dados pessoais possui o direito de solicitar do site DW
          Assessoria Contábel, através do canal específico de tratamento, a
        ...
        <ul>
          ...
          <li>
            ...
            cancelar os próximos envios clicando no link enviado junto ao e-mail
            de marketing;
          </li>

          <li>
            Para mudar suas preferências em relação às notificações (incluindo
            as comunicações de marketing) acesse a opção "Entrar";
          </li>
