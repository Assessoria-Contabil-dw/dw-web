  ...
  return (
    <LinkBase
      ...
      className={`
                ...
                ${
                  variant === 'outline' &&
                  ' rounded-lg border-[1px] font-medium border-slate-200 bg-transparent px-6 text-slate-800 hover:border-transparent hover:bg-slate-100 hover:text-slate-800'
                }
                ${
                  variant === 'line' &&
