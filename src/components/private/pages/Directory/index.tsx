...
export default function Directory() {
  ...
  function handleRegisterDirectory() {}
    ...
    <div className="flex flex-col gap-2">
      <div className="flex items-end justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          {user?.role === 'ADMIN' && (
            <ButtonIcon
              className="border-none border-second bg-second text-white hover:bg-secondHover hover:text-white"
              title="Cadastrar"
              onClick={handleRegisterDirectory}
              icon={<Plus className="h-fit w-4" />}
            />
          )}
        </div>
      </div>
