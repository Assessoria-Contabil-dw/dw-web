...
export default function TableVencimentVigency() {
  ...
  >(["dashboardVigency"], () => vigencyService.getVenciment(), {
  ...
  return (
    <fieldset className="fieldset w-full p-4">
      <div className="mb-4">
        <h4 className="text-h4">Vigência em vencimento</h4>
        <span className="text-span">
          Diretórios com data de vencimento próximo
        </span>
      </div>
